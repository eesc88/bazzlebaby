...
import com.houkew.bazzlebaby.utils.AMapUtil;
...
public class PoiKeywordSearchActivity extends FragmentActivity implements
    ...
    public void nextButton() {
        if (query != null && poiSearch != null && poiResult != null) {
            if (poiResult.getPageCount() - 1 > currentPage) {
                ...
                AppShow.showToast(getResources().getString(R.string.no_result));
            }
        }
    }
    ...
    protected void doSearchQuery() {
        ...
        String city = location == null ? "北京" : location.getAdCode();
    ...
    public View getInfoWindow(final Marker marker) {
        ...
        button.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LogUtils.i(marker.getTitle());
                LogUtils.i(marker.getPosition().toString());
    ...
    public void onPoiSearched(PoiResult result, int rCode) {
        ...
        if (rCode == 0) {
            if (result != null && result.getQuery() != null) {// 搜索poi的结果
                ...
                AppShow.showToast(getResources().getString(
                        R.string.no_result));
            }
        } else if (rCode == 27) {
            AppShow.showToast(getResources().getString(
            ...
            AppShow.showToast(getResources().getString(R.string.error_key));
        } else {
            AppShow.showToast(
