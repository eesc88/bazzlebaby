...
public class RoundNetworkImageView extends NetworkImageView {
	...
	public RoundNetworkImageView(Context context, AttributeSet attrs) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.RoundNetworkImageView);

		mBorderRadius = a.getDimensionPixelSize(
				R.styleable.RoundNetworkImageView_borderRadius,
				(int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
						BODER_RADIUS_DEFAULT, getResources()
								.getDisplayMetrics()));// 默认为10dp
		Log.e("TAG", mBorderRadius + "");
		type = a.getInt(R.styleable.RoundNetworkImageView_type, TYPE_CIRCLE);// 默认为Circle
